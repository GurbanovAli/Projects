...
export default class Layers extends Component {
    ...
    render () {
        return (
            <div
                className={`concrete-layer ${this.props.isActive ? 'active-layer' : ''}`}
            ...
            >
                {this.props.editMode ? (
                    ...
                    <div
                        ...
                        onDoubleClick={this.handleChooseLayer.bind(this)}
                    >
                        {this.props.name}
                    </div>
                )}
                <button
                    ...
                    onClick={this.props.deleteLayer.bind(this, this.props.layerId)}
                >
                    X
                </button>
            </div>
